    ...
    $('.video-popup').magnificPopup({
        ...
        iframe: {
            markup: '<style>.mfp-iframe-holder .mfp-content {max-width: 900px;height:500px}</style>' +
                ...
                // `<iframe src="https://player.vimeo.com/video/337272884?h=cc3fdf852e?autoplay=1& muted=1" frameborder="0" allow="autoplay  fullscreen; picture-in-picture" allowfullscreen></iframe>`
                `<iframe src="https://player.vimeo.com/video/337272884?h=cc3fdf852e&autoplay=1" width="640" height="360" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe>` 
                +
                '</div></div>'
        }
    });
